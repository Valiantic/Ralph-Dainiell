    ...
    return (
        <section className="profile-hero" style={{
            ...
            <div className="hero-cards-wrapper" style={{ display: 'flex', gap: '16px', flex: '1 1 600px', flexWrap: 'wrap' }}>
                ...
                {/* 4. Socials Group Card — NEW DESIGN */}
                <div className="card socials-card" style={{
                    ...
                    <Link href={data.socials.facebook || '#'} target="_blank" className="social-btn facebook-btn" style={{
                        ...
                        background: '#f3f4f6', transition: 'all 0.3s ease'
                    }}>
            ...
            <style jsx>{`
                ...
                .instagram-btn:hover { background: linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888) !important; }
                .youtube-btn:hover { background: #FF0000 !important; }
                .linkedin-btn:hover { background: #0A66C2 !important; }
