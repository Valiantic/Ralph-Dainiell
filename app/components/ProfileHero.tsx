...
export const ProfileHero = ({ data }: ProfileHeroProps) => {
    ...
    return (
        <section className="profile-hero" style={{
            ...
            {/* TOP ROW: Photo + Bio always side by side */}
            <div className="hero-top-row" style={{
                ...
                {/* 2. Main Bio Info */}
                <div className="hero-info" style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '6px', minWidth: 0 }}>
                    <h1 className="hero-name" style={{ fontSize: '28px', fontWeight: 800, letterSpacing: '-0.5px', lineHeight: 1.1, color: '#000', margin: 0 }}>{data.name}</h1>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#000', fontSize: '13px' }}>
                        <IoLocationOutline size={15} color="#000" />
                        {data.location}
                    </div>
                    <div className="hero-roles" style={{ fontSize: '18px', fontWeight: 500, color: '#000', marginBottom: '6px' }}>
                        {data.roles.join(' \\ ')}
                    </div>
                    <div className="hero-buttons" style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                        <Link
                            ...
                            className="cv-button"
                            style={{
                                background: '#2b6ef2', color: '#fff', padding: '10px 20px',
                                borderRadius: '14px', fontWeight: 700, display: 'flex',
                                alignItems: 'center', gap: '8px', textDecoration: 'none',
                                fontSize: '14px', height: '44px', boxSizing: 'border-box'
                            }}
                        >
                        ...
                        <div className="card phone-card" style={{
                            padding: '10px 16px', borderRadius: '14px', display: 'flex',
                            alignItems: 'center', gap: '8px', fontWeight: 700, fontSize: '14px',
                            height: '44px', boxSizing: 'border-box', border: '1.5px solid #000'
                        }}>
            ...
            {/* BOTTOM ROW: Cards — stack on mobile, side by side on wider screens */}
            <div className="hero-cards-wrapper" style={{ display: 'flex', gap: '16px', width: '100%', flexWrap: 'wrap', alignItems: 'stretch' }}>
                ...
                <div className="card contact-card" style={{
                    ...
                    flex: '1 1 280px', borderRadius: '24px', border: '1.5px solid #000',
                ...
                <div className="card opportunities-card" style={{
                    ...
                    flex: '1 1 220px', borderRadius: '24px', border: '1.5px solid #000',
            ...
            <style jsx>{`
                /* Desktop: top row takes natural width, no override needed */
                ...
                /* Mobile: photo+name stay side by side, just smaller */
