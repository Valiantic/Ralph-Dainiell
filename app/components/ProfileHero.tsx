                    ...
                    >
                        ...
                        <Link
                            ...
                            style={{
                                ...
                                textDecoration: 'none',
                                background:
                                    hoveredSocial === 'facebook' ? '#1877F2' : '#fff',
                                transition: 'all 0.3s ease',
                            }}
                        >
                            <div
                            ...
                            <span
                                style={{
                                    fontSize: '13px',
                                    fontWeight: 600,
                                    color: hoveredSocial === 'facebook' ? '#fff' : '#333',
                                    transition: 'all 0.3s ease',
                                }}
                            >
                                Facebook
                        ...
                        <Link
                            ...
                            style={{
                                ...
                                background:
                                    hoveredSocial === 'instagram'
                                        ? 'linear-gradient(45deg, #F77737, #FD1D1D, #833AB4)'
                                        : '#fff',
                                transition: 'all 0.3s ease',
                            }}
                        >
                            ...
                            <span
                                style={{
                                    fontSize: '13px',
                                    fontWeight: 600,
                                    color: hoveredSocial === 'instagram' ? '#fff' : '#333',
                                    transition: 'all 0.3s ease',
                                }}
                            >
                                Instagram
                        ...
                        <Link
                            ...
                            style={{
                                ...
                                textDecoration: 'none',
                                background:
                                    hoveredSocial === 'youtube' ? '#FF0000' : '#fff',
                                transition: 'all 0.3s ease',
                            }}
                        >
                            <div
                            ...
                            <span
                                style={{
                                    fontSize: '13px',
                                    fontWeight: 600,
                                    color: hoveredSocial === 'youtube' ? '#fff' : '#333',
                                    transition: 'all 0.3s ease',
                                }}
                            >
                                YouTube
                        ...
                        <Link
                            ...
                            style={{
                                ...
                                textDecoration: 'none',
                                background:
                                    hoveredSocial === 'linkedin' ? '#0A66C2' : '#fff',
                                transition: 'all 0.3s ease',
                            }}
                        >
                            <div
                            ...
                            <span
                                style={{
                                    fontSize: '13px',
                                    fontWeight: 600,
                                    color: hoveredSocial === 'linkedin' ? '#fff' : '#333',
                                    transition: 'all 0.3s ease',
                                }}
                            >
                                LinkedIn
