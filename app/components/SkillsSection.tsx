...
export const SkillsSection = ({ skills }: SkillsSectionProps) => {
    const categories: Skill['category'][] = ['Programming Languages', 'UI Development', 'App Architecture', 'Networking', 'Database', 'Tools & Version Control'];
        ...
        >
            ...
            >
                <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginBottom: '20px' }}>
                    ...
                    <h2 style={{ fontSize: '19.5px', fontWeight: 800, paddingTop: '2px' }}>Tech Skills</h2>
                </div>
