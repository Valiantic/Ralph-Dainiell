    ...
    <>
      <div className="rounded-2xl border border-gray-200 bg-white p-4 sm:p-5 flex flex-col justify-between gap-3 min-h-[200px]">
        ...
        <div className="flex justify-center">
          <button
            onClick={openModal}
            className="w-full max-w-[160px] py-2 rounded-xl border border-gray-300
      ...
      {isModalOpen && (
        ...
        >
          <div
            className="w-full sm:w-auto sm:min-w-[400px] sm:max-w-[460px]
                       bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl
                       p-5 sm:p-6 modal-enter"
          >
            {isSuccess ? (
              <div className="flex flex-col items-center justify-center py-6 text-center gap-2">
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Your recommendation will be received via my personal email
                  address
                </p>
              </div>
            ) : (
              ...
              <>
                    ...
                    {images.map((img, i) => (
                      <div
                        ...
                        className="relative w-14 h-14 rounded-xl overflow-hidden
                                   border border-gray-200 group cursor-pointer shrink-0"
                      >
                        ...
                        <button
                          ...
                          className="absolute inset-0 bg-black/55 text-white text-xl font-bold
                ...
                <div className="flex items-center justify-between mt-3 gap-2">
                  ...
                  <button
                    onClick={handleSend}
                    disabled={!canSend}
                    className="px-5 py-1.5 rounded-xl bg-gray-900 text-white
